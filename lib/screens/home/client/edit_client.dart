...
class _EditClientState extends State<EditClient> {
  final nameCotroller = TextEditingController(text: "Abdelwahd colgate");
  final cityCotroller = TextEditingController(text: "Agadir");
              ...
              children: [
                ...
                DropdownButton<String>(
                  ...
                  onChanged: (String? newValue) {
                    var selectedCity =
                        cities.where((element) => element['city'] == newValue);
                    coordinates = {
