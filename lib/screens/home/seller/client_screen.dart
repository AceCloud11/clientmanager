...
class ClientSellerScreen extends StatefulWidget {
  const ClientSellerScreen({Key? key}) : super(key: key);

  @override
  _ClientSellerScreenState createState() => _ClientSellerScreenState();
}

class _ClientSellerScreenState extends State<ClientSellerScreen> {
...
void exportExcel(String id) async {
